...
public class Processor {
	...
	public Processor()
	{
		...
		IFUnit = new InstructionFetch(this, IF_EnableLatch, IF_OF_Latch, EX_IF_Latch, OF_EX_Latch, EX_MA_Latch, MA_RW_Latch); // added EX_MA_Latch, MA_RW_Latch
		OFUnit = new OperandFetch(this, IF_OF_Latch, OF_EX_Latch, IF_EnableLatch, EX_MA_Latch, MA_RW_Latch); // added IF_EnableLatch, EX_MA_Latch, MA_RW_Latch
		EXUnit = new Execute(this, OF_EX_Latch, EX_MA_Latch, EX_IF_Latch, IF_OF_Latch, MA_RW_Latch, IF_EnableLatch); // added IF_OF_Latch, MA_RW_Latch, IF_EnableLatch
		MAUnit = new MemoryAccess(this, EX_MA_Latch, MA_RW_Latch, OF_EX_Latch, IF_OF_Latch, IF_EnableLatch); // added OF_EX_Latch, IF_OF_Latch, IF_EnableLatch
